...
// const drawAmountLine = (selection, data, width, yScale) => {
//   const drawLine = d3.line();

//   const coords = data.map((d) => [
//     [0, yScale(d.amount.value)],
//     [width + CHART.MARGIN.RIGHT, yScale(d.amount.value)]
//   ]);

//   const selectionWithData = selection
//     .selectAll("path.amount-line")
//     .data(coords);

//   selectionWithData.attr("d", drawLine);
...
// const drawAmountValues = (selection, data, width, yScale) => {

// const selectionWithData = selection.selectAll("text.amount-text").data(data);

// selectionWithData.append("text").text((d) => formatAmount(d.amount.value));
...
//   .attr("fill", "red") //GOAL.AMOUNT.VALUE.TEXT_COLOR
//   .attr("dy", "0.32em")
...
//   )
//   .attr("y", (d) => yScale(d.amount.value));
...
// export const drawGoals = (selection, data, xScale, yScale, width, height) => {
//   drawAmountLine(selection.goals, data, width, yScale);
//   drawAmountValues(selection.goals, data, width, yScale);
